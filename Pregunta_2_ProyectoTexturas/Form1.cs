    ...
    public partial class Form1 : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                ...
                con.ConnectionString = @"server=DESKTOP-5TH3NCL\MSSQLSERVER1;database=academico;user=ejemplo324;pwd=123456";
                cmd.Connection = con;
                ...
                cmd.CommandText = "insert into colores values('" + textBox4.Text + "'," + cR.ToString() + "," + cG.ToString()
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                ...
                if (intselectedindex >= 0)
                {
                    ...
                    cn.ConnectionString = @"server=DESKTOP-5TH3NCL\MSSQLSERVER1;database=academico;user=ejemplo324;pwd=123456";
                    cm.Connection = cn;
